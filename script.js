...
throwUpButton.onclick = function() {
  ...
  gameOverText.innerHTML = "I lied, you never obtained a glider. You died due to not paying attention"
}
...
insult.onclick = function() {
  ...
  gameOverScreen.style.display = "block";
  gameOverText.innerHTML = "You encountered a guardian and destroyed everything!!"
}
